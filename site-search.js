(() => {
  ...
  const SEARCH_ITEMS = [
    ...
    },
    {
      type: "product",
      label: "Product",
      title: "PC Optimizer Suite",
      url: "/store/product/pc-tweaks/",
      keywords: ["optimizer", "tweaks", "performance", "fps", "windows", "gaming"],
      weight: 130,
    },
    {
      type: "page",
      ...
      title: "Reviews",
      url: "/reviews/",
      keywords: ["reviews", "feedback", "opinions", "testimonials"],
      weight: 100,
    },
    {
      type: "page",
